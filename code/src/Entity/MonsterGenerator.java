...
public class MonsterGenerator { 
    ...
    public static Monster generate(int level){
        ...
        int randomMonsterId = (int)(randomNumber*4+1); 
        switch (randomMonsterId) {
            case 1:
                ...
                break;
            case 2:
                newMonster = new AllOrNothingMonster(10 + (int)(randomNumber*15), 1 + (int)(randomNumber*2), (int)(randomNumber*5), "Fantôme", 1 + (int)(randomNumber*3));
            break;
            case 3:
